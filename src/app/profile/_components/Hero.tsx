    ...
    <header className="pt-40 pb-20">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          <h1 className="text-charcoal mx-auto max-w-4xl font-serif text-5xl leading-[1.1] md:text-7xl">
            A considered studio for thoughtful clients and meaningful places.
          </h1>
          <p className="text-charcoal/70 max-w-2xl text-lg leading-relaxed md:text-xl">
