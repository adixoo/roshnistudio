  ...
  return (
    <section className="bg-accent px-6 py-32">
      <div className="mx-auto max-w-4xl space-y-12 text-center">
        <h2 className="font-serif text-4xl leading-[1.1] font-light text-white md:text-5xl">
          &quot;We don&apos;t just design buildings; we craft the spatial
          framework for your life&apos;s most meaningful moments.&quot;
        </h2>

        <p className="mx-auto max-w-2xl text-base leading-relaxed font-light text-white/70 italic">
